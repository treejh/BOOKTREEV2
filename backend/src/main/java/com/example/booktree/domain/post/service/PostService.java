package com.example.booktree.domain.post.service;

import com.example.booktree.domain.blog.entity.Blog;
import com.example.booktree.domain.blog.service.BlogService;
...
import com.example.booktree.domain.post.dto.request.PostRequestDto;
import com.example.booktree.domain.post.dto.response.PostResponseDto;
import com.example.booktree.domain.post.dto.response.PostTop3ResponseDto;
...
import static com.example.booktree.global.utils.ImageUtil.DEFAULT_POST_IMAGE;
