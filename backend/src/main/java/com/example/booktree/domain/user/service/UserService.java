package com.example.booktree.domain.user.service;
...
import com.example.booktree.domain.email.entity.EmailMessage;
import com.example.booktree.domain.email.service.EmailService;
...
import com.example.booktree.domain.follow.repository.FollowRepository;
import com.example.booktree.global.image.entity.Image;
import com.example.booktree.global.image.repository.ImageRepository;
...
import com.example.booktree.domain.likecomment.repository.LikeCommentRepository;
import com.example.booktree.domain.likepost.repository.LikePostRepository;
import com.example.booktree.domain.likereply.repository.LikeReplyRepository;
import com.example.booktree.domain.popularpost.service.PopularPostService;
import com.example.booktree.domain.post.entity.Post;
import com.example.booktree.domain.post.repository.PostRepository;
import com.example.booktree.domain.reply.repository.ReplyRepository;
import com.example.booktree.domain.role.entity.Role;
import com.example.booktree.domain.role.repository.RoleRepository;
import com.example.booktree.domain.user.dto.request.UserPasswordRequestDto;
import com.example.booktree.domain.user.dto.request.UserPatchRequestDto;
import com.example.booktree.domain.user.dto.request.UserPhoneNumberRequestDto;
import com.example.booktree.domain.user.dto.request.UserPostRequestDto;
import com.example.booktree.domain.user.entity.User;
import com.example.booktree.domain.user.repository.UserRepository;
import com.example.booktree.global.utils.CreateRandomNumber;
...
import static com.example.booktree.global.utils.ImageUtil.DEFAULT_USER_IMAGE;
