package com.example.booktree.global.image.controller;

import com.example.booktree.global.image.dto.request.ImageRequestDto;
import com.example.booktree.global.image.dto.response.ImageResponseDto;
...
public class ImageController {
    ...
    public ResponseEntity<String> deleteFileByFileId(@PathVariable("imageId") Long imageId){
